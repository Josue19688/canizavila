import ContactSection from "@/components/public/Contacto"
import { Valores } from "@/components/public/Valores"
    ...
    <section className="pt-28  lg:pt-8">
        ...
        <h5 className="text-3xl sm:text-3xl text-neutral-500 lg:text-md text-center tracking-wide">
                ...
                <span className="bg-gradient-to-r from-orange-500 to-neutral-800 text-transparent bg-clip-text">
                    Líderes con Trayectoria, Experiencia y Compromiso
                </span>
                </h5>
            </div>
            ...
            <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
                    <div className="text-center text-gray-500 dark:text-gray-400" >
                        <img className="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src="/c.jpg" alt="Bonnie Avatar"/>
                        <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a className="text-neutral-500" href="#">Dr. Leone Caniz</a>
                        </h3>
                        <p>Consultor especialista</p>
                        <ul className="flex justify-center mt-4 space-x-4">
                            <li>
                                <a href="https://josuevasquez.vercel.app" target="_blank" className="text-[#00acee] hover:text-gray-300 dark:hover:text-white">
                            ...
                            <li>
                                <a href="https://wa.me/+50233283075" target="_blank" className="text-[#00acee] hover:text-gray-300 dark:hover:text-white">
                            ...
                            <li>
                                <a href="https://linkedin.com/in/advin-josue-vasquez-latin-a649a4291" target="_blank" className="text-[#00acee] hover:text-gray-300 dark:hover:text-white">
                            ...
                            <li>
                                <a href="https://github.com/Josue19688" target="_blank" className="text-[#00acee] hover:text-gray-300 dark:hover:text-white">
